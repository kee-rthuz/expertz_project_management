...
const ProjectCountCard = ({ count, onNavigate }) => {
  return (
    <div className="bg-white mt-16 rounded-[4px] shadow-md p-4 flex items-center justify-between w-[380px] h-[10vh]">
      ...
      <div 
        className="text-gray-600 cursor-pointer hover:text-gray-800 transition-colors duration-300"
        onClick={onNavigate}
        role="button"
...
const Dashboard = () => {
  ...
  <button
    className="bg-blue-600 text-white py-2  px-4 rounded hover:bg-blue-700 transition-colors duration-300 w-70"
    onClick={togglePopup}
  >
    New Project
  </button>
